...
export type Phase =
  ...
  | 'night-phase-6'
  /**
   * آخر خطوة في الليل: يستيقظ المُخفي وحده ويختار من يساعده.
   *
   * ليست مرحلة نهارية رغم موقعها بعد المواعيد الستة — الأعين ما زالت مغلقة،
   * والراوي ينادي المُخفي وحده. لذلك تبدأ بـ `night-` مثل أخواتها: كل ما يسأل
   * «هل نحن في الليل؟» يجب أن يجيب بنعم هنا أيضًا.
   */
  | 'night-accomplices'
  | 'secret-actions'
  | 'discussion'
